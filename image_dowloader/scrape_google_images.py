...
def main():
    ...
    for searchtext in searchtexts:
        ...
        url = "https://www.google.co.in/search?q=" + searchtext + \
              "&source=lnms&tbm=isch&tbs=itp:photo"
        ...
        # imges = driver.find_elements_by_xpath('//div[@class="rg_meta"]') # not
        #  working anymore
        imges = driver.find_elements_by_xpath('//div[contains(@class,"rg_meta")]')
        "Total images:", len(imges), "\n"
        for img in imges:
            img_count += 1
            ...
            try:
                ...
                f = open(download_path + searchtext.replace(" ", "_") + "/" + str(
                    downloaded_img_count) + "." + img_type, "wb")
                f.write(raw_img)
                f.close
